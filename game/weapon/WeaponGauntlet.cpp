...
void rvWeaponGauntlet::Attack(void) {
	...
	if (gameLocal.isMultiplayer) { // jb547 - changed from false to true, maybe this will get gauntlet to sp
		idActor* actor_ent = 0;
	...
	if (!gameLocal.isMultiplayer)	{ // jb547 - changed from true to false, maybe this will get gauntlet to sp
		idPlayer * player;
